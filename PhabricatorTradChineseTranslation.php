...
Specify a list of dictionaries. Each dictionary describes a footer item. These keys are supported:
  ...
  'Authorization token from Twilio service.' => 'Twilio 服務的認証密鑰。',
  'Autoincrement' => '自動遞增',
  'Automatic' => '自動',
...
' => NULL,
  ...
  'Allow HTTP Basic Auth' => '允許 HTTP 基礎認証',
...
IMPORTANT: 此功能為新功能、尚在實驗且並受支援，使用風險自負。',
  ...
  'Configured credential is invalid.' => '已設定的憑証為無效的。',
  ...
  'Credential' => '憑證',
  'Credential required but not configured.' => '需要憑証但尚未設定。',
...
要做危險變更前請先編輯檔案。',
  ...
  'Disable HTTP Basic Auth' => '關閉 HTTP 基礎認証',
  ...
  'Enable HTTP Basic Auth for repositories.' => '開啟檔案庫 HTTP 基礎認証。',
...
`%s`' => NULL,
  ...
  'New credential PHID, or null.' => '新憑証 PHID 或 null。',
...
Consider using SSH for authenticated access to repositories instead of HTTP.' => 'Phabricator 可以使用 HTTP 基礎認証來透過 HTTP 提供檔案庫。

由於 HTTP 基礎認証較 SSH 認証不安全，因此預設為關閉的。若您仍想使用是，您仍可在此開啟此功能。由於 Phabricator 使用了 HTTPS 因此此功能沒有什麼不安全，但它比起 SSH 對攻擊者的障礙較低。

請考慮使用 SSH 來認証對檔案庫的存取來取代 HTTP。',
...
' => NULL,
  ...
  '%s closed this task as %s.' => '%s 關閉了這個工作為 %s。',
  ...
  'By Project' => '依專案',
  'By User' => '依使用者',
  'CHANGES TO TASK DESCRIPTION' => NULL,
