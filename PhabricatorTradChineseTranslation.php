...
final class PhabricatorTradChineseTranslation
  ...
  'Handles policy exceptions which occur when a user tries to do something they do not have permission to do.' => '處理當使用者嘗試執行一些他們沒有權限執行的動作所造成的政策例外。',
...
' => NULL,
  ...
  'Achievements and Notoriety' => NULL,
  'Activate Badge' => '啟用徽章',
...
If you specify an invalid rsvp, the command is ignored. This command has no effect if you do not specify an rsvp.' => NULL,
  ...
  'File' => '檔案',
  'File mime type of "%s" is not a valid viewable image.' => NULL,
  'Files' => '檔案',
  'Form' => '表單',
  'From' => '來自',
  'Function' => '函數',
...
`%s`' => NULL,
  ...
  'New policy PHID or constant.' => '新政策 PHID 或常數。',
