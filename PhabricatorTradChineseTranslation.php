...
' => NULL,
  ...
  'Some patches could not be applied to "%s": %s' => NULL,
...
Commit(s) to reparse: %s' => NULL,
  ...
  'Storage is up to date on "%s". Use "%s" for details.' => NULL,
