...
Reason: %s' => NULL,
  ...
  'Hide or show inline comment.' => NULL,
  ...
  'Jump to next inline comment, including hidden comments.' => NULL,
  'Jump to next inline comment.' => NULL,
  'Jump to previous change.' => NULL,
  'Jump to previous file.' => NULL,
  'Jump to previous inline comment, including hidden comments.' => NULL,
...
請參考在說明文件中的 [[ %s | 專案使用者指南 ]] 來取得詳細資訊，這個程序將無法還原。',
  ...
  'Milestone' => '里程碑',
  'Milestone Of' => '里程碑所屬',
  'Milestone projects do not support subprojects or milestones.' => NULL,
  'Milestones' => '里程碑',
  'Milestones can be created for this project.' => NULL,
  'Natural' => '自然',
  ...
  'Subprojects can be created for this project.' => NULL,
...
%s' => NULL,
  ...
  'This project has no milestones.' => NULL,
  'This project has no subprojects.' => NULL,
  ...
  'Workboard: %s' => '工作看板: %s',
  'You are a member and you will receive mail that is sent to all project members.' => NULL,
