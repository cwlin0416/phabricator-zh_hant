...
You should configure a CDN or alternate file domain to mitigate this risk. Configuring a CDN will also improve performance. See [[ %s | %s ]] for instructions.' => NULL,
  ...
  'Configure full-text search services.' => NULL,
...
When cluster addresses are defined, Phabricator hosts will also reject requests to interfaces which are not whitelisted.' => NULL,
  ...
  'Domain used to generate Message-IDs.' => '用來產生 Message-ID 的網域。',
  ...
  'Elasticsearch Index Schema Mismatch' => NULL,
...
This option defines a list of netblocks which Phabricator will decline to connect to. Generally, you should list all private IP space here.' => NULL,
  ...
  'Show Email Preferences Link' => '顯示電子郵件偏好連結',
...
' => NULL,
  ...
  '%s added %s auditor(s) for %s: %s.' => '%s 加入了 %d 位稽查員給 %s: %s。',
  '%s added %s auditor(s): %s.' => '%s 加入了 %d 位稽查員: %s。',
  '%s added %s reverted commit(s) for %s: %s.' => '%s 加入了 %s 已還原的提交給 %s: %s。',
  '%s added %s reverted commit(s): %s.' => '%s 加入了 %s 已還原的提交: %s。',
  '%s added %s reverting commit(s) for %s: %s.' => '%s 加入了 %s 還原中的提交給 %s: %s。',
  ...
  'Commit Fields' => '提交欄位',
  'Commit Has Revision' => NULL,
  'Commit Has Task' => NULL,
...
%s' => NULL,
  ...
  'User has not been awarded any badges.' => NULL,
