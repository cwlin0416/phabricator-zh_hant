...
Transforms               | 轉換          |
  ...
  'Configure forms for creating and editing packages in Owners.' => '設定在 Owner 用來建立與編輯 Package 的表單。',
  ...
  'Create New Package' => '建立新 Package',
...
☠ Your changes will be destroyed the next time state is synchronized.' => NULL,
  ...
  '%s attached a new secret to this credential.' => null,
  ...
  'End Date (Future to Past)' => null,
  'End Date (Past to Future)' => null,
  ...
  'Weak' => null,
  'Weak (Control Unowned Paths)' => null,
  'Welcome to %s' => '歡迎光臨 %s',
