...
After completing configuration, copy the **Client ID** and **Client Secret** to the fields above.' => NULL,
  ...
  '%s changed the task status from "%s" to "%s".' => '%s 更改了該工作的狀態從 "%s" 為 "%s"。',
...
NOTE: Before you disable the queue, make sure {{auth.email-domains}} is configured correctly for your install!' => NULL,
  ...
  'No tasks have points assigned.' => NULL,
  'No tasks have positive points.' => NULL,
  'No tasks.' => NULL,
...
' => NULL,
  ...
  'You do not have permission to edit this dashboard.' => NULL,
  'You do not have permission to edit this object.' => '您沒有權限編輯這個物件。',
  'You do not have permission to interact with this object.' => NULL,
...
For more information, see "Managing Storage Adjustments" in the documentation.' => NULL,
  ...
  'You must choose a URI to link to.' => NULL,
  ...
  'You must choose a dashboard.' => NULL,
  ...
  'You must choose a form.' => NULL,
  'You must choose a label name.' => NULL,
  'You must choose a link name.' => NULL,
  ...
  'You must choose an application.' => NULL,
