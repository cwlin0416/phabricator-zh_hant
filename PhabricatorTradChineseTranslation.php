...
Multi-Factor auth        | 多重認証    | 
  ...
  'Application Email' => '應用程式電子郵件',
  'Application Emails' => '應用程式電子郵件',
  ...
  'Choose User' => NULL,
  'Choose a dashboard template to start with.' => '請選擇要使用的資訊看版範本。',
  ...
  'Do not send me an email when I take an action' => '當我執行動作時不要發送郵件通知',
  ...
  'Send me an email when I take an action' => '當我執行動作時發送郵件通知',
  ...
  'You do not have permission to edit this object.' => '您沒有權限編輯此物件。',
...
☠ Your changes will be destroyed the next time state is synchronized.' => NULL,
  ...
  'Bugs' => null,
  'Build individual panels to display on your homepage dashboard.' => null,
  ...
  'Create a Badge' => null,
  'Create a Countdown' => null,
  'Create a Credential' => null,
  ...
  'Edit Countdown: %s' => null,
  'Edit Countdowns' => null,
  'Edit Credential: %s' => null,
  'Edit Dashboard: %s' => null,
  'Edit Device: %s' => null,
  'Edit Document: %s' => null,
  ...
  'Edit Menu' => '編輯選單',
  'Edit Menu Item' => null,
  'Edit Menu Item: %s' => null,
  'Edit Mock: %s' => null,
  'Edit Namespace' => null,
  'Edit Namespace: %s' => null,
  'Edit Network: %s' => null,
  'Edit Nuance Queue Configurations' => null,
  'Edit Nuance Source Configurations' => null,
  'Edit OAuth Applications' => null,
  'Edit OAuth Server' => null,
  'Edit OAuth Server: %s' => null,
