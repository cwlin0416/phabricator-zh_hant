...
要首頁安裝此資訊看板，可編輯您在首頁的個人或全域選單，然後點選右方新增選單項目中的資訊看板。',
  ...
  'Collapse File' => '摺疊檔案',
  'Collapse or expand inline comment.' => NULL,
...
Reason: %s' => NULL,
  ...
  'Edit selected inline comment.' => NULL,
  ...
  'JIRA Issues' => 'JIRA 問題',
  'Jump to next change.' => NULL,
  'Jump to next file.' => NULL,
  'Jump to next inline comment, including collapsed comments.' => NULL,
  'Jump to next inline comment.' => NULL,
  'Jump to previous change.' => NULL,
  'Jump to previous file.' => NULL,
  'Jump to previous inline comment, including collapsed comments.' => NULL,
  'Jump to previous inline comment.' => NULL,
  'Jump to the table of contents.' => NULL,
  'Land Revision' => '降落修訂',
...
NOTE: This property is cached, so you will need to purge the cache after making changes if you want the new configuration to affect existing revisions. For instructions, see **[[ %s | Managing Caches ]]** in the documentation.' => NULL,
  ...
  'Mark or unmark selected inline comment as done.' => NULL,
  'Modified' => '已修改',
  'Moved Here' => NULL,
  'Must Review' => '需要審查',
  'Needs Review' => '需要審查',
...
' => NULL,
  ...
  'Branch status in unavailable while the repository is still importing.' => NULL,
  'Branch: %s' => NULL,
  'Branches' => '分支',
  'Browse' => '瀏覽',
...
提交規則可以用來發送郵件、標記提交、觸發稽查以及執行建置計劃。',
  ...
  'Repository has no URIs set.' => NULL,
...
☠ Your changes will be destroyed the next time state is synchronized.' => NULL,
  ...
  'This revision is still under review. Only revisions which have been accepted may land.' => '此修訂仍在審查中，只有己審查被接受的修訂可以降落。',
...
' => NULL,
  ...
  '%s updated the task description for %s.' => NULL,
  '%s updated the task description.' => NULL,
  '(No Project)' => '(無專案)',
  '(Not Assigned)' => '(尚未分配)',
  '(Ungrouped)' => NULL,
  '(Up For Grabs)' => '(從缺)',
...
%s' => NULL,
  ...
  'All unread notifications will be marked as read. You can not undo this action.' => '所有未讀的通知將會標記為己讀，您將無法還原這個動作。',
  'Connecting...' => '連線中...',
  'Disconnected' => '連線中斷',
