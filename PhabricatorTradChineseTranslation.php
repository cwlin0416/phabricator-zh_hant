...
Parent Task/Subtask      | 父工作/子工作 | 工作
  ...
  'OPcache Not Configured for Production' => '未設定 OPcache 供正式上線使用',
  ...
  'Other badge activity not listed above occurs.' => '上述未列到的其他 Badge 活動。',
  'Other blog activity not listed above occurs.' => '上述未列到的其他 Blog 活動。',
  ...
  'Someone changes the badge\'s details.' => '有人更改了 Badge 的詳細資訊。',
  ...
  'Someone comments on a badge.' => '有人在 Badge 評論。',
...
☠ Your changes will be destroyed the next time state is synchronized.' => NULL,
  ...
  'Issue #%d' => null,
  'It is not possible for users to push any dangerous changes to a Subversion repository. Pushes to a Subversion repository can always be reverted and never destroy data.' => null,
  'It will no longer be possible to delete branches from this repository, or %s push to this repository.' => null,
  'Items' => null,
  ...
  "More Branches\342\200\246" => null,
  ...
  'OAuth clients may never call this method.' => null,
  ...
  'Product' => null,
  "Profile (200px \303\227 200px)" => null,
  ...
  'Reinstate All' => null,
  'Reinstate all instances of this recurrence\n          that have not been individually cancelled?' => null,
  'Relationships' => null,
  ...
  '%s updated the paste\'s title from "%s" to "%s".' => null,
  ...
  'Changeset ID "%s" is part of diff ID "%s", but that diff is attached to reivsion "%s", not revision "%s".' => null,
  ...
  'Closed Status' => '已完成狀態',
  'Commit "%s" has been deleted: it is no longer reachable from any ref.' => null,
  ...
  'Only specific legacy relationships are supported!' => null,
  ...
  'Skipping, this is a tag of a tag.' => null,
  ...
  "Use Unicode Glyphs: \342\232\231" => "使用 Unicode 符號: \342\232\231",
