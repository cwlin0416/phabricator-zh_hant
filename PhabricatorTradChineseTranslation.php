...
After completing configuration, copy the **Client ID** and **Client Secret** to the fields above.' => NULL,
  ...
  '%s created this build.' => '%s 建立了這個 Build。',
  ...
  '%s enabled this provider.' => '%s 開啟了此提供者。',
  ...
  '%s named this room "%s".' => '%s 命名此討會議室為 "%s"。',
  ...
  '%s removed %d image(s): %s.' => '%s 移除了 %d 位參與者: %s。',
  ...
  '%s renamed this project from "%s" to "%s".' => '%s 重新命名了此專案從 "%s" 為 "%s"。',
  '%s renamed this queue from "%s" to "%s".' => NULL,
  '%s renamed this repository from "%s" to "%s".' => '%s 重新命名了此檔案庫從 "%s" 為 "%s"。',
...
NOTE: Before you disable the queue, make sure {{auth.email-domains}} is configured correctly for your install!' => NULL,
  ...
  'No databases have any issues.' => NULL,
...
(Note that if you run other applications against the same database, they may not work with %s. Be careful about enabling it in these cases and consider migrating Phabricator to a different database.)' => NULL,
  ...
  'PHP setting "%s" should be set to "-1" to avoid deprecation warnings.' => NULL,
  'PHPAST' => NULL,
  'PHPMailer' => NULL,
...
' => NULL,
  ...
  'Type the name of a user, application or Herald rule...' => NULL,
  'Type viewer()...' => NULL,
