...
' => NULL,
  ...
  '%s awarded this badge to %s recipient(s): %s.' => '%s 頒發了這個徽章給 %s 位收件者: %s。',
  ...
  '%s revoked this badge from %s recipient(s): %s.' => '%s 撤銷了這個徽章從 %s 位收件者: %s。',
  ...
  'Badges' => '徽章',
  'Badges Award' => NULL,
  'Badges let you award and distinguish special users throughout your install.' => NULL,
  ...
  'This badge does not have any recipients.' => '此徽章沒有任何接收者。',
