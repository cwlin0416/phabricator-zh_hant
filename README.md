...
ROOT='/usr/local/lib/php' # You can hard-code the path here instead.
...
root@dev:~/phabricator-translate # ls
.cache                  mergedStrings           phabricator-zh_hant     watch_trans.sh
extract_trans.sh        parseI18nStrings.php    update_trans.sh
generateDiff.sh         parseI18nStrings2.php   upgrade.sh
root@dev:~/phabricator-translate # cat upgrade.sh
#!/bin/sh
